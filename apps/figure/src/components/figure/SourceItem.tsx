...
export const SourceItem: Component<{
  ...
  return (
    <div class="flex place-content-between place-items-center gap-x-4 gap-y-2 rounded-lg bg-neutral-100 p-2 text-neutral-900 shadow-md outline outline-neutral-400 dark:bg-black dark:text-neutral-100 dark:outline-neutral-500">
      <div class="flex place-content-between gap-2">
        <span class="flex place-items-center gap-4">
          <span class="w-8 rounded bg-neutral-500 px-2 text-center text-white">
            {props.srcIdx + 1}
          </span>
      ...
      <Show when={(sources()?.length ?? 0) > 1}>
        <button
          ...
          class="text-neutral-500 hover:text-rose-500"
          type="button"
          onClick={() =>
            setFigureConfigs(
              props.figIdx,
